...
print(f'Forma1 base: {forma1.base}, altura {forma1.altura}, tipo {forma1.tipo}, área {calc_area(forma1)}cm²')

print(f'Forma2 base: {forma2.base}, altura {forma2.altura}, tipo {forma2.tipo}, área {calc_area(forma2):.2f}cm²')
